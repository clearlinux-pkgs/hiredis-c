...
Version  : 1.0.0
Release  : 1
URL      : https://github.com/redis/hiredis/archive/refs/tags/v1.0.0.tar.gz
Source0  : https://github.com/redis/hiredis/archive/refs/tags/v1.0.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629405895
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/hiredis-1.0.0/COPYING %{buildroot}/usr/share/package-licenses/hiredis-c/e9c1298de98016808910005a33de3a5f25dce05e
pushd clr-build
%make_install
popd
